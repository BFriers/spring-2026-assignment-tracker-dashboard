...
Conditional formatting for deadline alerts

Dynamic sorting and filtering

Organized task tracking by course

Clear dashboard-style layout for visibility
...
Logical formulas (IF, FILTER, ARRAYFORMULA)
